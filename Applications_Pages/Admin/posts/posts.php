        ...
        <div class="Content-session">
                ...
                <div class="row">
                	...
                	<a href="Shirts.html">
                		...
                		<img src="Assets/images/contentAdmin/Shirts/1.jpg" width="100%" height="50%">
					</a>
                	</div>
                	<div class="col-sm-4">
                	<a href="watch.html">
                		<img src="Assets/images/contentAdmin/Watch/1.jpg" width="100%" height="50%">
						</a>
                	</div>
                	<div class="col-sm-4">
                	<a href="kurta.html">
                		<img src="Assets/images/contentAdmin/kurta/12.jpg" width="100%" height="50%">
						</a>
                	</div>
                </div>
                <br>
                <br>
                 <div class="row">
                	<div class="col-sm-4">
						<a href="bodyspray.html">
							<img src="Assets/images/contentAdmin/BodySpray/1.jpg" width="100%" height="50%">
						</a>
                	</div>
                	<div class="col-sm-4">
                	<a href="jeans.html">
                		<img src="Assets/images/contentAdmin/Jeans/1.jpg" width="100%" height="50%">
						</a>
                	</div>
                	<div class="col-sm-4">
