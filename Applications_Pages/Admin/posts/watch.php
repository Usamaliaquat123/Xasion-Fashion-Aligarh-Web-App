...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="Assets/css/watch-style.css">
      <!-- bootstrap CSS -->
							...
							<div class="product-items">
								<form action="" method="post">
									...
									<div class="product-price">
										Product Price $
										<input type="number" placeholder="Product Price" name="pro_price">
									</div>
									<br>
									<br>
...
<script>
	$(document).ready(function() {
		...
		function products() {
			...
			$("body").delegate(".deletewatch","click",function(event){
        event.preventDefault();
        
        var idme = $(this).data("id3");
        ...
        ({
            url: "Assets/action.php",
            method:"POST",
            data : {deleteproductwatch:1, pid: idme},
            success : function(data){
               $('#cart_msg').html(data);
				products();
            }
