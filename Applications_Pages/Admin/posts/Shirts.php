...
<head>
	...
	<link rel="stylesheet" href="Assets/css/shirts-style.css">
	<!-- bootstrap CSS -->
												...
												<div class="row">
													...
													<div class="col-sm-3">
														<div class="btn-new-items-add">
															<input type="button" id="submit" name="btnsave" class=" btn btn-primary" value="Add new item">
														</div>
														<br>
