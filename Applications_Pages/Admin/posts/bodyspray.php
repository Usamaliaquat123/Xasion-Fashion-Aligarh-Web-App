...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="Assets/css/bodyspray.css">
      <!-- bootstrap CSS -->
...
<script>
	$(document).ready(function() {
		...
		function products() {
			...
			$("body").delegate(".deletebodyspray","click",function(event){
        event.preventDefault();
        
        var idme = $(this).data("id5");
        ...
        ({
            url: "Assets/action.php",
            method:"POST",
            data : {deleteproductbodyspray:1, pid: idme},
            success : function(data){
               $('#cart_msg').html(data);
				products();
            }
