...
<head>
	...
	<link rel="stylesheet" href="user_security.css">
	<!-- bootstrap CSS -->
			...
			<div class="Content-session">
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-sm-8">
							<div class="heading-usr-sec">
								<p>About User Security</p>
							</div>
						</div>
						<div class="col-sm-2"></div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<div class="para1-usr-sec">
								<p>In a Windows environment, a user profile is a record of user-specific data that define the user's working environment. The record can include display settings, application settings, and network connections. What the user sees on his or her computer screen, as well as what files, applications and directories they have access to, is determined by how the networkadministrator has set up the user's profile.</p>
								<p>Roaming profiles are user profiles that are stored in the server. Each time the user logs on, their profile is requested and sent to whatever machine makes the request. This allows the user to move from machine to machine and still maintain a consistent personal working environment. Network administrators find roaming profiles to be especially beneficial in a work or learning environment when more than one user shares the same computer, or when a user moves from place-to-place during the course of a workday.</p>
							</div>
						</div>
					</div>
				</div>
