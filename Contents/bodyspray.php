...
<head>
	...
	<link rel="stylesheet" href="Contents_Assets/css/bodyspray.css">
	<!-- bootstrap CSS -->
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="Heading-main-bodyspray">
						<p>Buy Perfumes and bodyspray</p>
					</div>
					<div class="para">
				...
				<div class="col-sm-6">
					<div class="trans-prfume-png">
						<img src="Contents_Assets/images/bodyspray/1-transparent.png" width="80%" height="80%">
					</div>
				</div>
			</div>
		</div>
...
$(document).ready(function(){
    ...
    function products(){
      ...
      $("body").delegate("#products-of-cart-bodyspray","click",function(event){
